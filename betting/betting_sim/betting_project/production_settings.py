...
# Simplified password validation for Vercel
...
# Media files - note that Vercel has a read-only filesystem
# For production, you would need to use a service like AWS S3
MEDIA_URL = '/media/'
